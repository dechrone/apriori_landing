                ...
                >
                  <Card hover className="border-l-[3px] border-l-accent-gold h-full">
                    <CardContent className="flex items-center gap-4 py-6">
                      <div className="w-12 h-12 shrink-0 rounded-[8px] bg-[#1F2937]/10 flex items-center justify-center">
            ...
            {isProductFlow && assets.length > 0 ? (
              ...
              <div
                className={`
                  ...
                  ${dragOver
                    ? 'border-[#1F2937] border-solid bg-[#F3F4F6]'
              ...
              >
                <UploadCloud className={`w-4 h-4 ${dragOver ? 'text-[#111827]' : 'text-[#9CA3AF]'}`} />
                <span className={`text-[13px] ${dragOver ? 'text-[#111827]' : 'text-[#9CA3AF]'}`}>
              ...
              <div
                ...
                onDragLeave={handleDragLeave}
              >
                <UploadCloud className={`w-8 h-8 mx-auto mb-2 ${dragOver ? 'text-[#1F2937]' : 'text-[#9CA3AF]'}`} />
                <p className={`text-[14px] font-medium ${dragOver ? 'text-[#111827]' : 'text-[#6B7280]'}`}>
                ...
                {uploadingFiles.map((uf) => (
                  <div key={uf.id} className="bg-white border border-[#E8E4DE] rounded-[10px] px-4 py-3">
                    ...
                    <div className="mt-2 h-1 bg-[#E5E7EB] rounded-full overflow-hidden">
                      <div
                        className={`h-full rounded-full transition-all duration-300 ${uf.status === 'done' ? 'bg-[#10B981]' : uf.status === 'error' ? 'bg-[#EF4444]' : 'bg-[#1F2937]'}`}
                      ...
                      <div className="px-4 py-[14px]">
                        ...
                        {assetType === 'ad-creative' && !hasCaption && (
                          <button
                            ...
                            className="flex items-center gap-1.5 bg-[#F3F4F6] rounded-[6px] px-[10px] py-1.5 mt-[10px] w-full text-left hover:bg-[#D1D5DB] transition-colors"
                          >
                            <AlertCircle className="w-3.5 h-3.5 text-[#111827] shrink-0" />
        ...
        {!isComparator && (
          <div className="fixed bottom-0 left-0 lg:left-[240px] right-0 z-40 bg-white border-t border-[#E8E4DE] px-4 lg:px-7 py-3">
            <div className="max-w-[1600px] mx-auto flex items-center justify-between">
              ...
              {/* Right: Upload button */}
              <button
                className="inline-flex items-center gap-2 px-5 py-[10px] text-[14px] font-semibold text-white bg-[#1F2937] rounded-[10px] hover:bg-[#111827] transition-colors shadow-[0_4px_12px_rgba(31, 41, 55,0.35)]"
                onClick={handleUploadClick}
              >
