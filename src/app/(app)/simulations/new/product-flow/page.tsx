        ...
        {selectedCount > 0 && (
          <div className="mt-5 border-t border-[#F3F4F6] pt-4">
            ...
            <p className="text-[12px] text-[#6B7280] mt-0.5 mb-3 leading-[1.5]">
              The mindset each cohort arrives with — it shapes how they judge your screen. We pre-fill it; tweak to match your real funnel. (This is their entry mindset, not their goal.)
            </p>
              ...
              {formData.selectedSegmentIds.map((id) => {
                ...
                return (
                  <div key={id}>
                    ...
                    <textarea
                      value={formData.segmentIntentOverrides[id] ?? seg.entry_intent ?? ''}
                      onChange={(e) => {
                        const v = e.target.value;
                        setFormData((prev) => ({
                          ...prev,
                          segmentIntentOverrides: { ...prev.segmentIntentOverrides, [id]: v },
                        }));
                      }}
