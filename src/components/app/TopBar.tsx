          ...
          <div ref={menuRef} className="relative">
            ...
            >
              {photoURL ? (
                ...
                <div className="flex items-center justify-center shrink-0 w-[34px] h-[34px] rounded-full bg-[#F59E0B] text-white text-sm font-semibold">
                  {initials}
                </div>
              )}
              <ChevronDown
                ...
                <div className="px-4 py-3 border-b border-[#F3F4F6]">
                  <div className="flex items-center gap-3">
                    {photoURL ? (
                      ...
                      <div className="flex items-center justify-center shrink-0 w-10 h-10 rounded-full bg-[#F59E0B] text-white text-sm font-semibold">
                        {initials}
                      </div>
                    )}
