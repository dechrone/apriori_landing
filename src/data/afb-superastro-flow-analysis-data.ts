...
export const afbSuperastroFlowAnalysisData: FlowAnalysisData = {
  ...
  rootCauses: [
    ...
    },
    {
      id: "RC4",
      screen: "S9",
      title: "No \u2018don\u2019t know\u2019 affordance for users uncertain about exact birthplace",
      detail:
        "The DOB and birth-time pickers offer skip / approximation paths, but the place-of-birth screen demands an exact city with no equivalent escape hatch. Users uncertain of their precise birthplace abandon rather than guess.",
      affectedPersonas: ["Anita C.", "Raj M."],
      severity: "high",
    },
    {
      id: "RC5",
  ...
  oneBet: {
    ...
    personaDetails: [
      ...
      {
        name: "Vikram J.",
        role: "35yo NRI in Dubai · AI response in Sanskrit-heavy Hindi he can\u2019t parse",
      },
      {
        name: "Aditya S.",
    ...
    whatChanges: [
      ...
      {
        number: "+4",
        title: "English-Default AI for Diaspora",
        description:
          "Detect English-primary users via phone locale or ad source and route them to a plain-English AI persona that glosses Sanskrit terms inline (\u2018dasha \u2014 the planetary period you\u2019re in\u2019). One-tap toggle back to Hindi.",
        icon: "globe",
        benefit: "Unblocks NRI / English-primary segment",
      },
    ],
  },
  ...
  patterns: [
    ...
    {
      stat: "7/100",
      title: "Diaspora users can\u2019t parse the Sanskrit-heavy AI response",
      description:
        "English-primary NRIs receive AI responses dense with technical Sanskrit terms (dasha, antardasha, navamsa) that they can\u2019t parse. The flow accepts their inputs, but the AI persona was tuned for an Indian-resident, Hindi-literate audience.",
    },
    {
      stat: "6/100",
  ...
  quotes: [
    ...
    {
      quote:
        "I made it through onboarding and the AI started talking about my dasha and antardasha and the navamsa. I grew up in Dubai \u2014 I can read Devanagari but these technical Sanskrit words mean nothing to me. There\u2019s no English mode toggle. I closed the app.",
      attribution: "35yo NRI Software Architect · Dropped at S11",
      dropScreen: "S11",
    },
  ],
