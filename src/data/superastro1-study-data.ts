 ...
 */
export const superastro1StudyData: StudyData = {
  study: {
    study_id: "SUPERASTRO_ONBOARD_v01",
    study_name: "SuperAstro Onboarding: Ad Click to First AI Response to Subscription",
    flow_name:
      "Ad → App Install → Phone OTP → Kundli Data Entry (7 screens) → AI Chat (Mahesh Ji) → Subscription Paywall",
    flow_version: "production_april_2026",
    date_run: "2026-04-13",
    total_users: 100,
    completed_users: 58,
    dropped_users: 42,
    ...
    persona_distribution: {
      "Devotional Completer": 18,
      "Stigma Guardian": 16,
      "Career Anxiety Seeker": 20,
      "Relationship Crisis User": 18,
      "Gen-Z Explorer": 15,
      "NRI Nostalgic": 13,
    },
  ...
  executive_summary: {
    ...
    sus_label: "Poor",
    avg_seq: 3.4,
    critical_drop_point: "AI Chat First Response: generic kundli instead of ad-specific answer",
    critical_drop_pct: 9,
    top_findings: [
      {
        rank: 1,
        finding:
          "Users from the 'Career kab set hogi?' ads who received a career-specific AI first response converted to subscription at 68%. The same cohort receiving a generic kundli converted at 22%. Currently 100% of AI responses are generic. You are paying performance-marketing rates for traffic and breaking the personalisation promise at the single most expensive moment in the funnel.",
      },
      {
        rank: 2,
        finding:
          "The highest-LTV segment (Devotional Completers, 83% completion, 3.2x 90-day retention) wants MORE onboarding detail, not less. They read 'skip birth time' as 'this app does not take astrology seriously.' Without segment-level simulation, the team would ship a faster onboarding, improve headline completion by ~8%, and lose 40% of subscription revenue within 90 days.",
      },
      {
        rank: 3,
        finding:
          "The phone-number gate is not a privacy problem. It is an identity problem. Stigma Guardians are not afraid of data leaks; they are afraid that 'astrology user' will surface in their UPI transaction history, SMS inbox, or a notification their colleague can see. The phone number links professional identity to a practice their social circle mocks.",
      },
    ],
    top_recommendation: {
      headline:
